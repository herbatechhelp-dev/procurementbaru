    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                        <path d="M10 8a3 3 0 100-6 3 3 0 000 6zM3.465 14.493a1.23 1.23 0 00.41 1.412A9.957 9.957 0 0010 18c2.31 0 4.438-.784 6.131-2.1a1.23 1.23 0 00.41-1.412C15.797 12.501 13.12 11 10 11s-5.797 1.501-6.535 3.493z" />
                    </svg>
                </div>
                <input id="name" class="block w-full pl-11" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Enter your full name" />
            </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="email" class="block w-full pl-11" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="Enter your email" />
            </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="password" class="block w-full pl-11 pr-10" type="password" name="password" required autocomplete="new-password" placeholder="Create a password" />
                <button type="button" class="eye-toggle" onclick="togglePasswordVisibility('password', 'eye-icon-pw', 'eye-slash-icon-pw')" aria-label="Toggle password visibility">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" class="eye-toggle" onclick="togglePasswordVisibility('password_confirmation', 'eye-icon-confirm', 'eye-slash-icon-confirm')" aria-label="Toggle password visibility">
