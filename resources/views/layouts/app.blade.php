...
<head>
    ...
    <style>
        ...
        /* Navbar & Sidebar */
        .dark-mode .main-header, .dark-mode .main-sidebar {
        ...
        .dark-mode .badge-success, .dark-mode .bg-success {
            background-color: rgba(40, 167, 69, 0.15) !important;
            color: #4ade80 !important;
            border: 1px solid rgba(40, 167, 69, 0.3) !important;
        }
        .dark-mode .badge-warning, .dark-mode .bg-warning {
            background-color: rgba(255, 193, 7, 0.15) !important;
            color: #fbbf24 !important;
            border: 1px solid rgba(255, 193, 7, 0.3) !important;
        }
        .dark-mode .badge-info, .dark-mode .bg-info {
            background-color: rgba(23, 162, 184, 0.15) !important;
            color: #38bdf8 !important;
            border: 1px solid rgba(23, 162, 184, 0.3) !important;
        }
        .dark-mode .badge-danger, .dark-mode .bg-danger {
        ...
        .dark-mode .text-secondary {
            color: #94a3b8 !important; /* Lighter cool-gray for readability */
        }
        .dark-mode .text-dark,
        .dark-mode .text-gray-900,
        .dark-mode .text-gray-800 {
            color: #f8fafc !important; /* Very light gray / nearly white */
        }
        .dark-mode .text-gray-600,
        .dark-mode .text-gray-500 {
            color: #cbd5e1 !important; /* Light-medium gray */
        }
        .dark-mode label,
